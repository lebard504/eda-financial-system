package com.devsu.financial.account_service.handler;
...
import com.devsu.financial.account_service.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleInsufficientFunds(InsufficientFundsException ex) {
        return ResponseEntity
                .status(422)
                .body(ResponseBuilder.error(422, ex.getMessage(), null));
    }
